...
/*
    Build a script
 */
var build_a_script = function (output) {
    return __awaiter(this, void 0, void 0, function () {
        var messages, body, response, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
...
var do_work = function () {
    return __awaiter(this, void 0, void 0, function () {
        var tag, work, allWork, result, resultFormated, saveSuccess, WORKER_NAME, workExe, e_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    tag = TAG + " | do_work | ";
                ...
                case 3:
                    ...
                    return [4 /*yield*/, build_a_script(work.work)];
                case 4:
                    result = _a.sent();
                ...
                case 8:
                    e_3 = _a.sent();
                    log.error(tag, "e: ", e_3);
                    log.error(tag, "e: ", e_3.message);
                    work.error = e_3.message;
